...
class CommonConfig(FairseqDataclass):
    ...
    # added
    ctxdict: Optional[str] = field(
        default=None, metadata={"help": "pkl file of ctxdict"},
    )
    tgtctxdict: Optional[str] = field(
        default=None, metadata={"help": "pkl file of ctxdict"},
    )
    dynamic_ctxdict: Optional[int] = field(
        default=0, metadata={"help": "pkl file of ctxdict"},
    )
    clus_evepc: Optional[int] = field(
        default=0, metadata={"help": "pkl file of ctxdict"},
    )
    n_cluster: Optional[float] = field(
        default=0, metadata={"help": "pkl file of ctxdict"},
    )
    clus_layer: Optional[int] = field(
        default=6, metadata={"help": "use which layer"},
    )
    rmspwords: Optional[int] = field(
        default=0, metadata={"help": "remove stopwords"},
    )
    clusalg: Optional[str] = field(
        default='kmeans', metadata={"help": "algorithm of clustering"},
    )
    topk2disk: Optional[int] = field(
        default=20, metadata={"help": "words to write to disk"},
    )
    clusiter: Optional[int] = field(
        default=100, metadata={"help": "multi head cluster"},
    )
    clustol: Optional[float] = field(
        default=1e-4, metadata={"help": "multi head cluster"},
    )
    clusseed: Optional[int] = field(
        default=1, metadata={"help": "seed for kmeans"},
    )
    #
